		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Torneio Belio",
									"targetURL": "#torneiobeliotorneiobelio-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"torneiobeliotorneiobelio-display": {
								"semanticObject": "torneiobeliotorneiobelio",
								"action": "display",
								"description": "Torneio feito por Cláudio Jesus",
								"title": "Torneio Belio",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=torneiobelio.torneiobelio",
									"url": sap.ui.require.toUrl("torneiobelio/torneiobelio")
								}
							}
						}
					}
